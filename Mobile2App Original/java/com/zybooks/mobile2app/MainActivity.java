...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // Formats date from CalendarView when clicking dates.
        ...
        // Listener function used for Navigation bar buttons on CalendarView
        // Created for Enhancement 2 & 3
        nav.setOnItemSelectedListener(new NavigationBarView.OnItemSelectedListener(){
            @Override
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                int id = item.getItemId();

                // Search Button ENHANCEMENT 2
                ...
                // if R.id.nav_home option

                // if R.id.nav_day option

                // Settings Button ENHANCEMENT 3
